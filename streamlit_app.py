...
# CSS für PROFESSIONELLEN DARK MODE
st.markdown("""
    <style>
...
ok_modus = st.radio("Oberkörper Modus:", ["Ausdauer (55%)", "Muskelaufbau (75%)"], horizontal=True)
...
with tabs[2]: display_exercises(["HT", "RDL", "ABD", "KB", "KB45"], True)
with tabs[3]: display_exercises(["RE", "RB", "BR", "SH", "HSH", "TD", "BC", "HC"], False)
with tabs[4]: display_exercises(["BS", "HS", "BP", "BSS", "BB", "AD", "SS"], True)
